...
const Sample = () => {
  ...
  return (
    <section className='sample_section w-auto my-10'>
      <div className='s-container w-full'>
        <div className='flex flex-wrap w-full'>
          <div className='sample_container bg-[#F0F8F8] flex flex-wrap mt-28 mb-[132px] md:pl-28 py-9'>
            <div className='top_text_sample w-[100%] flex flex-col gap-4 justify-around md:flex-row'>
              <div className='left_text flex flex-col'>
            ...
            <div className='right_sample_content flex flex-wrap gap-[11px] mx-auto mt-7 w-100% justify-center'>
              {divContent.map((item) => (
